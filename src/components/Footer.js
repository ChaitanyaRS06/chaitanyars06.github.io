      ...
      <FooterContent>
        <FooterSection>
          ...
          <p style={{ color: '#d1d5db', lineHeight: '1.6', fontSize: '0.95rem', marginBottom: '1.5rem' }}>
            AI Engineer at RootLogic Systems building end-to-end AI stacks for production-ready systems — agent
            workflows, orchestration, memory, evaluations, and observability. MS in Computer Science, University of Virginia (2025).
          </p>
          <SocialLinks>
            ...
            <a href="https://www.linkedin.com/in/chaitanya-shahane06/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
